...
def generate_launch_description():
    ...
    package_name="roverto_moveit_config").to_moveit_configs()
    ...
    pkg_path = get_package_share_directory('roverto_description')
    ...
    model_path = get_model_paths(['roverto_description'])
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare("roverto_description"), "rviz", "default.rviz"]
    )
